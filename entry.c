...
static void __init(app_t* app) {
    ...
    panel_t* panel1 = new_panel(frame, &group, &(bounding_box){100, 100, 400, 600}, "C:\\Users\\roygr\\CLionProjects\\stream-draw\\Resources\\heisenberg.jpg");
    push_comp_node(frame->header.components, panel1, PANEL_COMPONENT);
    // panel_t* panel2 = new_panel(frame, &group, &(bounding_box){0, 0, 100, 100}, "C:\\Users\\roygr\\CLionProjects\\stream-draw\\Resources\\heisenberg.jpg");
